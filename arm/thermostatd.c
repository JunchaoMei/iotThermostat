...
[arm] ${BUILDROOT_HOME}/output/host/usr/bin/arm-linux-gcc --sysroot=${BUILDROOT_HOME}/output/staging  thermostatd.c -o thermostatd
*/
#define _GNU_SOURCE
...
static void _do_work(void)
{
	for (int i = 1; true; ++i)
	{
		char *geturl = "hw2 -u http://18.222.58.97/IoT/project/runThermostat5min.php?entryid=";
		char *ending = " -g";
