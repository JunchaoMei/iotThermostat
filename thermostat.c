...
[arm] ${BUILDROOT_HOME}/output/host/usr/bin/arm-linux-gcc --sysroot=${BUILDROOT_HOME}/output/staging  -c thermostat.c -o thermostat
*/
#include <stdio.h>
#include <stdlib.h>
#include <curl/curl.h>
...
void printHelp()
{
	...
	printf("                         Notice: already installed for ARM chip\n");
	...
	printf("  uninstall          uninstall the thermostat device\n");
